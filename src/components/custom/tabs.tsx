                ...
                <TabsList className="relative flex items-center justify-between overflow-hidden">
                    {options.map((t, i) => (
                        <TabsTrigger
                            ...
                            value={t.id.toString()}
                            className="data-[state=active]:delay-100 data-[state=active]:bg-transparent data-[state=active]:text-background duration-300 z-10"
                        >
                            {t.name}
                        </TabsTrigger>
                    ))}
                    <div
                        className="absolute top-1 h-8 bg-primary rounded-md duration-300 -ml-1"
                        style={{
